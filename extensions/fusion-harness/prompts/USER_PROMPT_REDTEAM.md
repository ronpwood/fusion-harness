...
READ-ONLY CONTRACT: inspect with read/grep/find/ls only. Never modify the project, run shell commands, install anything, or claim you fixed something. If your lens genuinely finds nothing, say so plainly in one line — do not invent a finding to fill space.
